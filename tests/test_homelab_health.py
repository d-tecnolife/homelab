...
class ResultTreeTests(unittest.TestCase):
    ...
    def test_reads_success_and_redacts_unreachable_message(self):
        ...
        self.assertTrue(result["ops"]["reachable"])
        self.assertEqual(result["door"], {"reachable": False, "reason": "unreachable"})
    ...
    def test_status_detects_down_prometheus_target(self):
        hosts = {
            "monitoring": {
                ...
                "prometheus": {
                    "reachable": True,
                    "targets": [{"job": "node", "instance": "door:9100", "health": "down"}],
                },
            }
        }
...
class ProbeTests(unittest.TestCase):
    ...
    def test_prometheus_output_is_bounded_to_identity_and_health(self):
        ...
        response = {
            ...
            "data": {
                "activeTargets": [
                    {
                        "labels": {"job": "node", "instance": "door:9100", "secret": "omit"},
                        "health": "up",
                        "lastError": "omit",
                    }
                ]
        ...
        self.assertEqual(
            result,
            {
                "container": "running",
                "reachable": True,
                "targets": [{"job": "node", "instance": "door:9100", "health": "up"}],
            },
        )
        self.assertNotIn("secret", json.dumps(result))
    ...
    def test_expected_service_is_reported_missing(self):
        with mock.patch.object(probe, "service_state", return_value=None):
            result = probe.caddy_snapshot("door", 5)
